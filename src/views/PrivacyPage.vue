<template>
  <div class="wrap">
    <header>
      <ul class="header-wrap" @click="$router.push('/auth')">
        <li><awesome icon="suitcase" class="fas fa-suitcase"></awesome></li>
        <li><span class="title">Tripllo</span></li>
      </ul>
    </header>
    <p class="ls2 lh6 bs5 ts4">
      <em class="emphasis">황선태('https://tripllo.tech'이하 'Tripllo')</em
      >은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고
      개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은
      처리방침을 두고 있습니다.
    </p>
    <p class="ls2 lh6 bs5 ts4">
      <em class="emphasis">황선태('Tripllo')</em> 은(는) 회사는
      개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여
      공지할 것입니다.
    </p>
    <p class="ls2">
      ○ 본 방침은부터 <em class="emphasis">2020</em>년
      <em class="emphasis">12</em>월 <em class="emphasis">31</em>일부터
      시행됩니다.
    </p>
    <br />
    <p class="lh6 bs4">
      <strong
        ...
        사전동의를 구할 예정입니다.</strong
      >
    </p>
    <ul class="list_indent2 mgt10">
      <p class="ls2">가. 홈페이지 회원가입 및 관리</p>
      <p class="ls2">
        회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 서비스
    ...
    <p class="lh6 bs4">
      ...
      <em class="emphasis">황선태('Tripllo')</em>은(는) 법령에 따른 개인정보
    ...
    <ul class="list_indent2 mgt10">
      ...
      <li>
        보유근거 : 서비스 이용계약 또는 회원가입 해지시까지, 다만 채권․채무관계
        잔존시에는 해당 채권․채무관계 정산시까지
      </li>
      <li>
        관련법령 : 1)신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년<br />2)
    ...
    <p class="ls2">
      ① 정보주체는 황선태에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구
      등의 권리를 행사할 수 있습니다.
    </p>
    <p class="sub_p">
    ...
    <p class="lh6 bs4">
      <strong
        >5. 개인정보의 파기<em class="emphasis">황선태('Tripllo')</em>은(는)
        원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를
        파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.</strong
      >
    </p>
    <p class="ls2">
      ...
      5일 이내에, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 사업의 종료 등
      그 개인정보가 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로
    ...
    <p class="ls2">
      황선태 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지
      않습니다.
    </p>
    ...
    <p class="sub_p mgt10">
      ...
      <span class="colorLightBlue"
        >황선태(‘https://tripllo.tech’이하 ‘Tripllo)</span
      >
    ...
    <p />
    <p class="sub_p">
      ② 정보주체께서는 황선태(‘https://tripllo.tech’이하 ‘Tripllo) 의
      서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
      불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
      문의하실 수 있습니다. 황선태(‘https://tripllo.tech’이하 ‘Tripllo) 은(는)
    ...
    <p class="lh6 bs4">
      <strong
        >9. 개인정보의 안전성 확보 조치
        <em class="emphasis">황선태('Tripllo')</em>은(는) 개인정보보호법
    ...
    <p class="sub_p mgt10">
      ...
      접속 기록이 위변조 및 도난, 분실되지 않도록 보안기능 사용하고 있습니다.<br /><br />3.
      개인정보에 대한 접근 제한<br />
