<template>
  <div class="wrap">
    ...
    <main>
      <article>
        <header>
          <h1 class="main-title">개인 정보보호 방침</h1>
        </header>
        ...
        <p class="lh6 bs4">
          <strong
            >1. 개인정보의 처리 목적
            <em class="emphasis"
              >황선태('https://tripllo.tech'이하 'Tripllo')</em
        ...
        <p class="sub_p">
          ...
          문의하실 수 있습니다. 황선태(‘https://tripllo.tech’이하 ‘Tripllo)
